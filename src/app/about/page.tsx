        ...
        <div className="lg:col-span-8">
          <div className="prose prose-lg max-w-none">
            <p className="mb-4">
              ...
              functional digital experiences. With a background in both design and engineering, I
            ...
            <p className="mb-4">
              ...
              eventually led me to pursue formal education in computer science and design. Since
              then, I&apos;ve worked on a variety of projects, from web applications to mobile apps,
              always striving to create solutions that are both technically sound and user-friendly.
            </p>
            <p className="mb-8">
